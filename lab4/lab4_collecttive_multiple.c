...
int main(int argc, char *argv[]){
    ...
    MPI_Ibcast(&Brow,1,MPI_INT,0,MPI_COMM_WORLD,&req[0]);
    MPI_Ibcast(&Bcol,1,MPI_INT,0,MPI_COMM_WORLD,&req[0]);
    MPI_Ibcast(&matrix2[0][0],Brow*Bcol,MPI_DOUBLE,0,MPI_COMM_WORLD,&req[0]);
